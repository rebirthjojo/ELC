...
return(
    <div id='tap-wrapper' role='dialog' aria-modal="true" ref={modalRef} tabIndex={-1} onClick={(e) => e.stopPropagation()}>
        <div className='Always-area'><img className="title-image" src="/image/ELC.svg" />
        ...
        <div>
            {onTap === "left"&&(
                <div className='signinArea'>                    
                    ...
                    <img src='/image/e-mail.svg' className='email-icon' width="24" height="24" />
                    <input type='text' className='sign-email' placeholder='이메일을 입력하세요'/>
                    <span className='password'>비밀번호</span>
                    <img src='/image/lock.svg' className='lock-icon' width="24" height="24" />
            ...
            {onTap === "right"&&(
                <div className='signupArea'>
                    ...
                    <img src='/image/person.svg' className='person-icon' width="24" height="24" />
                    <input type='text' className='up-name' placeholder='이름을 입력하세요'/>
                    <span className='upEmail'>이메일</span>
                    <img src='/image/e-mail.svg' className='mail-icon' width="24" height="24" />
                    ...
                    <img src='/image/phone.svg' className='phone-icon' width="24" height="24" />
